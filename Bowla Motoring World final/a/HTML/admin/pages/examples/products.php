...
<html>
  <head>
    <meta charset="UTF-8">
    <title>AdminDashboard | Products</title>
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                <li><a href="invoice.html"><i class="fa fa-circle-o"></i> Invoice</a></li>
                 <li><a href="sales-list.php"><i class="fa fa-circle-o"></i> Sales List</a></li>
                <li><a href="products.php"><i class="fa fa-circle-o"></i> Products</a></li>
                <li><a href="clientlist.php"><i class="fa fa-circle-o"></i> Client List</a></li>
...
<?php
          if (isset($_POST['proid'])) {
           $admin->removeProduct($db,$_POST['proid']);
          }
