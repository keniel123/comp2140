              ...
              <div class="box box-primary">
                ...
                <div class="box-body">
                  <div class="form-group">
                    <input class="form-control" type="text" name="to" id="to" value="<?php if(isset($error)){ echo $_POST['to']; } ?>" >
                  </div>
                  <div class="form-group">
                    <input class="form-control " placeholder="Subject" type="text" name="subject" id="subject" value="<?php if(isset($error)){ echo $_POST['subject']; } ?>" >
                  </div>
                  <div class="form-group">
                    <textarea id="compose-textarea" class="form-control" style="height: 300px" name="Body" id="Body">
                ...
                <div class="box-footer">
                  <div class="pull-right">
                    ...
                    <button type="submit" class="btn btn-primary" name="submit" id="submit"><i class="fa fa-envelope-o"></i> Send</button>
                  </div>
