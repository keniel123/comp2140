<!--?php
        if (isset($_POST['placeOrder'])) {
            ...
            if ($_POST['billing_address_1'].$_POST['billing_address_2']=="") {
        ...
        if (isset($_POST['ship_to_different_address'])) {
            ...
            if ($_POST['shipping_address_1'].$_POST['shipping_address_2']=="") {
                 $error[]='Please enter a shipping address';
            }
             if ($_POST['shipping_postcode']=="") {
                 $error[]='Please enter a shipping postcode';
            }
        }
        else{
            shipping($db,$_SESSION['username']);
        }
        if (!isset($error) and !checkBillingAddress($db,$_SESSION['username'])) {
                $currentUser=$_SESSION['username'];
                billing($db,$_SESSION['username']);
                shipping($db,$_SESSION['username']); 
                
                $g=$db->prepare("DELETE FROM cart Where user='$currentUser' ");
                $g->execute(); 
                ...
                <div class="col-md-8">
                    <div class="product-content-right">
                        <div class="woocommerce">
                            <div class="woocommerce-info">Returning customer? <a href="?controller=pages&action=login">Click here to login</a>
                            </div>
                                    ...
                                    <div class="col-1">
                                        <div class="woocommerce-billing-fields">
                                            ...
                                            <p id="billing_email_field" class="form-row form-row-first validate-required validate-email">
                                                ...
                                                <input type="text" value="" placeholder="" id="billing_email" name="billing_email" class="input-text " value="<?php if(isset($error)){ echo $_POST['billing_email']; } ?>">
                                            </p>
                                            ...
                                            <div class="create-account">
                                                <p>Please Confirm Account Password Below.</p>
                                ...
                                <div id="order_review" style="position: relative;">
                                    <table class="shop_table">
                                        ...
                                        $total=0;
                                         $currentUser=$_SESSION['username'];
                                                ...
                                                $cart->execute();
                                                $y= $cart->fetchAll(PDO::FETCH_OBJ);
                                                if ($y) {
                                                    foreach ($y as $y) {
                                                        echo '<tr class="cart_item">';
                                        
                                                   echo'<td class="product-name">';
                                                    echo $y->Name .'<strong class="product-quantity">×'. $y->quantity.'</strong>';
                                                    echo'</td>';
                                                echo '<td class="product-total">';
                                               
                                                 echo '<span class="amount">$'.$y->quantity*$y->price.'</span> </td>';
                                    ...
                                    <div id="payment">
                                        ...
                                        <div class="form-row place-order">
                                            ...
                                            <input type="submit" data-value="Place order" value="Place order" id="placeOrder" name="placeOrder" class="button alt">
